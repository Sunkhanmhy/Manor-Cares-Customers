  ...
  switch (n) {
    case 'home':
      return (
        <BaseWrapper size={size}>
          <svg {...commonProps}>
            <path d="M3 11.5L12 4l9 7.5v8.5a1 1 0 0 1-1 1h-5.5v-5.5h-5V21H4a1 1 0 0 1-1-1z" fill="currentColor" opacity="0.58" />
    ...
    case 'office':
      return (
        <BaseWrapper size={size}>
          <svg {...commonProps}>
            <rect x="4" y="3" width="16" height="18" rx="1.8" fill="currentColor" opacity="0.56" />
    ...
    case 'star':
      return (
        <BaseWrapper size={size}>
          <svg {...commonProps}>
            <path d="M12 3.5l2.6 5.3 5.8.8-4.2 4.1 1 5.8L12 16.8 6.8 19.5l1-5.8-4.2-4.1 5.8-.8z" fill="currentColor" opacity="0.62" />
          </svg>
        </BaseWrapper>
      );
    case 'user':
      return (
        <BaseWrapper size={size}>
          <svg {...commonProps}>
            <circle cx="12" cy="8" r="3.2" fill="currentColor" opacity="0.7" />
            <path d="M4 20c0-3.3 3.6-6 8-6s8 2.7 8 6" fill="currentColor" opacity="0.55" />
          </svg>
        </BaseWrapper>
      );
    case 'location':
      return (
        <BaseWrapper size={size}>
          <svg {...commonProps}>
            <path d="M12 2C8.1 2 5 5.1 5 9c0 5.2 7 13 7 13s7-7.8 7-13c0-3.9-3.1-7-7-7z" fill="currentColor" opacity="0.56" />
            <circle cx="12" cy="9" r="2.2" fill="currentColor" opacity="0.82" />
          </svg>
        </BaseWrapper>
      );
    case 'clean':
      return (
        <BaseWrapper size={size}>
          <svg {...commonProps}>
            <rect x="3" y="3" width="18" height="6" rx="1.5" fill="currentColor" opacity="0.56" />
            <path d="M6 14c2-2 6-2 8 0s6 2 8 0" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round" opacity="0.8" />
          </svg>
        </BaseWrapper>
      );
    case 'calendar':
      return (
        <BaseWrapper size={size}>
          <svg {...commonProps}>
            <rect x="3" y="4" width="18" height="17" rx="2" fill="currentColor" opacity="0.52" />
    ...
    case 'money':
      return (
        <BaseWrapper size={size}>
          <svg {...commonProps}>
            <rect x="2" y="6" width="20" height="12" rx="2" fill="currentColor" opacity="0.5" />
    ...
    case 'invoice':
      return (
        <BaseWrapper size={size}>
          <svg {...commonProps}>
            <rect x="4" y="3" width="12" height="18" rx="1.5" fill="currentColor" opacity="0.52" />
    ...
    case 'bell':
      return (
        <BaseWrapper size={size}>
          <svg {...commonProps}>
            <path d="M15 17H9a3 3 0 0 0 6 0z" fill="currentColor" opacity="0.45" />
    ...
    case 'settings':
      return (
        <BaseWrapper size={size}>
          <svg {...commonProps}>
            <circle cx="12" cy="12" r="3" fill="currentColor" opacity="0.52" />
    ...
    case 'lock':
      return (
        <BaseWrapper size={size}>
          <svg {...commonProps}>
            <rect x="5" y="11" width="14" height="9" rx="2" fill="currentColor" opacity="0.52" />
    ...
    case 'clock':
      return (
        <BaseWrapper size={size}>
          <svg {...commonProps}>
            <circle cx="12" cy="12" r="9" stroke="currentColor" strokeWidth="1.2" opacity="0.55" />
    ...
    case 'menu':
      return (
        <BaseWrapper size={size}>
          <svg {...commonProps}>
            <rect x="3" y="6" width="18" height="2" rx="1" fill="currentColor" opacity="0.72" />
            <rect x="3" y="11" width="18" height="2" rx="1" fill="currentColor" opacity="0.72" />
            <rect x="3" y="16" width="18" height="2" rx="1" fill="currentColor" opacity="0.72" />
          </svg>
        </BaseWrapper>
      );
    default:
